      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-[#64748B] text-base max-w-md mx-auto">
            Del consultorio médico a la farmacia, en 3 pasos. Sin papel. Sin fraude.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-14">
          <StepCard
            ...
            description="El médico emite una receta o ficha clínica usando Face ID. Sin contraseñas. Sin burocracia."
          />
          <StepCard
            number={2}
            emoji="⛓️"
            title="Blockchain la ancla"
            description="TrustLeaf registra el documento en Stellar Blockchain. Inmutable, verificable, permanente."
          />
          <StepCard
            number={3}
            emoji="📱"
            title="El paciente controla"
            description="El paciente recibe un QR. Comparte su historial con cualquier médico, farmacia o especialista — cuando quiere, con quien quiere."
            isLast
          />
        </div>
