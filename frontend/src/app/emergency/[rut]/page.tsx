  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white">
      ...
      <div className="bg-red-600 px-4 py-3 flex items-center justify-center gap-3">
        <HeartIcon />
        <span className="font-bold text-sm tracking-wide uppercase">Datos de Emergencia Médica</span>
        <HeartIcon />
      </div>

      {/* TrustLeaf branding */}
      <div className="border-b border-[#334155] px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#64748B] text-xs">· Acceso de emergencia · Sin login</span>
        </div>
        ...
        {patient ? (
          <>
            ...
            <div className="bg-[#1E293B] rounded-2xl border border-[#334155] p-5">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="shrink-0 w-16 h-16 rounded-2xl bg-red-900/40 border-2 border-red-500 flex flex-col items-center justify-center">
                  <span className="text-red-400 text-xs font-bold">Sangre</span>
            ...
            <div className="bg-[#1E293B] rounded-2xl border border-[#334155] p-5">
              <div className="flex items-center gap-2 mb-4">
                <PillIcon />
                <h2 className="text-white font-bold text-sm">Medicamentos Actuales</h2>
              </div>
            ...
            {patient.conditions.length > 0 && (
              <div className="bg-[#1E293B] rounded-2xl border border-[#334155] p-5">
                <h2 className="text-white font-bold text-sm mb-3">Diagnósticos Relevantes</h2>
                <div className="flex flex-wrap gap-2">
            ...
            <div className="bg-[#1E293B] rounded-2xl border border-[#334155] p-5">
              <div className="flex items-center gap-2 mb-3">
                <PhoneIcon />
                <h2 className="text-white font-bold text-sm">Contacto de Emergencia</h2>
              </div>
            ...
            <div className="rounded-2xl border border-[#10B981]/30 bg-[#10B981]/5 p-4">
              <div className="flex items-start gap-3">
                <ShieldIcon />
                <div>
                  <p className="text-[#10B981] font-semibold text-sm">Datos verificados en Stellar Blockchain</p>
                  <p className="text-[#64748B] text-xs mt-1">
                    Última actualización: {formatDate(patient.lastUpdated)}
                  </p>
                  <p className="text-[#64748B] text-xs mt-0.5">Verificado por: {patient.verifiedBy}</p>
            ...
            <p className="text-center text-[#475569] text-xs pb-4">
              Este QR fue generado por el paciente. Los datos son de acceso público de emergencia y no requieren login.
              TrustLeaf no almacena datos en servidores propios — todo está en Stellar Blockchain.
            </p>
          </>
        ) : (
          /* Not found */
          <div className="text-center py-16">
            ...
            <h1 className="text-xl font-bold text-white mb-2">Paciente no encontrado</h1>
            <p className="text-[#64748B] text-sm mb-4">
              No hay datos de emergencia registrados para el RUT{" "}
              <span className="font-mono text-[#94A3B8]">{rutRaw}</span>.
            </p>
            <p className="text-[#475569] text-xs">
              RUT de prueba: 12345678-9
            </p>
          </div>
        )}
      </main>
